...
class VisualizationComponents:
    ...
    def create_stacked_area_chart(
        ...
        if colors is None:
            colors = [config.get_indicator_config(var).get('color', '#1f77b4') 
        ...
        for var in variables:
            if var in df.columns:
                ...
                ax.plot(data.index, data.values,
                       ...
                       color=indicator_config.get('color', '#1f77b4'),
            ...
            if asset in df.columns:
                ...
                if not data.empty:
                    ...
                    ax.fill_between(normalized.index, normalize_start, normalized.values,
                                   alpha=0.15, color=indicator_config.get('color', '#1f77b4'))
...
# Global visualization components instance
