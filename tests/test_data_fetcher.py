...
class TestDataFetcher:
    ...
    def test_fetch_yahoo_current_fallback(self, mock_requests, mock_ticker_class):
        ...
        # Mock requests fallback success
        mock_response = Mock()
    ...
    def test_to_date_index(self):
        ...
        assert len(result) == 2
        assert result.index[0].time() == datetime.min.time()  # Normalized to date
